...
func (r *fixedKeyIDResolver) ResolveWriteKey(store.KeyContext) string { return r.keyID }
...
func (alwaysFailingResolver) ResolveWriteKey(store.KeyContext) string { return "" }
