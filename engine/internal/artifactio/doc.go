// Package artifactio is the store-side write orchestration for artifacts:
...
//
// Layering: artifactio ← store, artifactio → {artifact, driver, index,
...
// pure format stays in engine/artifact; artifactio adds the I/O around it.
//
