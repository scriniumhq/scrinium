...
// callers two layers up; that's the same identity in two locations,
// not two distinct concepts. Splitting the same identity into per-
// layer duplicates with `var X = otherpkg.X` re-exports has been
// tried and produced exactly the kind of confusion this package is
// meant to remove.
//
