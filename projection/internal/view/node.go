...
// --- Tree selector ---
//
// RootView names a logical tree the projection maintains. It is core
// vocabulary shared by the node machinery and the read queries; the query
// result types themselves live in queries.go.
