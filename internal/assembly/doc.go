...
// package config/declarative, parsed and validated there — into a live,
// fully assembled Scrinium stack: store, index, projection view, and the
// read/write FSOps facade, ready to use. The assembly's own job is
// wiring components; the configuration model (shape, defaults,
// validation, policy mapping) is not here.
//
